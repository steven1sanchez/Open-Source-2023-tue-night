        ...
        <div class="col-6">
            ...
            <form method="POST" action="isabella-rgb-hex">
                ...
                <div class="form-group mb-2">
                    ...
                    <input value="<c:out value="${results.colorValueR}" />" type="number"
                    ...
                    <input value="<c:out value="${results.colorValueG}" />" type="number"
                           class="form-control numRGB hidden"
                           id="colorValueG" name="colorValueG">

                    <label for="colorValueB" class="numRGB hidden">Blue Color Value:</label>
                    <input value="<c:out value="${results.colorValueB}" />" type="number"
                           class="form-control numRGB hidden"
